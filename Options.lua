...
MC.weeklySubCategory = Settings.RegisterCanvasLayoutSubcategory(MC.mainOptionsCategory, weeklyPanel, "Weekly Lockout Filters")
...
MC.dailySubCategory = Settings.RegisterCanvasLayoutSubcategory(MC.mainOptionsCategory, dailyPanel, "Daily Lockout Filters")
...
mainTitle:SetText("Master Collector V1.5.1")
...
function MC.CreateCheckbox(name, variable, parent, tabButton)
    ...
    checkbox.SetValue = function(self)
        MasterCollectorSV[variable] = self:GetChecked()
...
function MC.CreateSocialLinks(panel)
    ...
    CreateLinkButton(panel, "Watch me on Twitch! [https://www.twitch.tv/divinekate]", "https://www.twitch.tv/divinekate", 32)
...
function MC.CreateOptions()
    local hideBossesWithMountsObtained = MC.CreateCheckbox("Hide Obtained Mounts", "hideBossesWithMountsObtained", mainPanel)
    local showBossesWithNoLockout = MC.CreateCheckbox("Show Instances with No Lockout", "showBossesWithNoLockout", mainPanel)
    ...
    local showRarityDetail = MC.CreateCheckbox("Show Rarity Attempts (must have mount names enabled)", "showRarityDetail", mainPanel)
    ...
    local showSLWeeklyDungeons = MC.CreateCheckbox("Show Shadowlands Mythic Dungeons", "showSLWeeklyDungeons", weeklyPanel)
    ...
    local showWoDWorldBosses = MC.CreateCheckbox("Show Warlords of Draenor World Bosses", "showWoDWorldBosses", weeklyPanel)
    local showPandariaWorldBosses = MC.CreateCheckbox("Show Pandaria World Bosses", "showPandariaWorldBosses", weeklyPanel)
    ...
    local showSLDailyDungeons = MC.CreateCheckbox("Show Shadowlands Mythic Daily Dungeons", "showSLDailyDungeons", dailyPanel)
    ...
    local hideGrindMountsTab = MC.CreateCheckbox("Hide Anytime Grinds Tab", "hideGrindMountsTab", mainPanel, MC.grindMountsTab)
    ...
    local showSummonDepthsTimer = MC.CreateCheckbox("Show Nazjatar Summon from the Depths Timer", "showSummonDepthsTimer", eventPanel)
    local showMawAssaultTimer = MC.CreateCheckbox("Show SL The Maw Assault Timer", "showMawAssaultTimer", eventPanel)
    local showBeastwarrensHuntTimer = MC.CreateCheckbox("Show SL The Maw Beastwarrens Hunt Timer", "showBeastwarrensHuntTimer", eventPanel)
    local showTormentorsTimer = MC.CreateCheckbox("Show SL The Maw Tormentors of Torghast Timer", "showTormentorsTimer", eventPanel)

    hideGrindMountsTab:SetPoint("TOPLEFT", hideMinimapButton, "BOTTOMLEFT")
    ...
    showGarrisonInvasions:SetPoint("TOPLEFT",hideWeeklyTab,"BOTTOMLEFT")
    ...
    showSLRaids:SetPoint("TOPLEFT",showBFADungeons,"BOTTOMLEFT")
    ...
    showBfaDailies:SetPoint("TOPLEFT",showClassicDailies,"BOTTOMLEFT")
    showSLDailies:SetPoint("TOPLEFT",showBfaDailies,"BOTTOMLEFT")
    ...
    showSummonDepthsTimer:SetPoint("TOPLEFT", showBfaAssaultTimer, "BOTTOMLEFT")
