...
repPanel.name = "Reputations"
repPanel.parent = mainPanel.name
MC.repSubCategory = Settings.RegisterCanvasLayoutSubcategory(MC.mainOptionsCategory, repPanel, "Reputations")
...
mainTitle:SetText("Master Collector V1.8")
...
function MC.CreateOptions()
    ...
    local showTWWDungeons = MC.CreateCheckbox("Show The War Within Mythic Dungeons", "showTWWDungeons", weeklyPanel)
    ...
    local showTWWRaids = MC.CreateCheckbox("Show The War Within Raids", "showTWWRaids", weeklyPanel)
    ...
    local showTanaanRares = MC.CreateCheckbox("Show Warlords of Draenor Tanaan Jungle Rares", "showTanaanRares", dailyPanel)
    local showArgusRares = MC.CreateCheckbox("Show Legion Argus Rares", "showArgusRares", dailyPanel)
    local showArathiRares = MC.CreateCheckbox("Show Battle of Azeroth Arathi Highlands Rares", "showArathiRares", dailyPanel)
    local showDarkshoreRares = MC.CreateCheckbox("Show Battle of Azeroth Darkshore Rares", "showDarkshoreRares", dailyPanel)
    local showMechagonRares = MC.CreateCheckbox("Show Battle of Azeroth Mechagon Rares", "showMechagonRares", dailyPanel)
    local showNazRares = MC.CreateCheckbox("Show Battle of Azeroth Nazjatar Rares", "showNazRares", dailyPanel)
    local showUldumRares = MC.CreateCheckbox("Show Battle of Azeroth Uldum Rares", "showUldumRares", dailyPanel)
    local showValeRares = MC.CreateCheckbox("Show Battle of Azeroth Vale of Eternal Blossom Rares", "showValeRares", dailyPanel)
    local showSLRares = MC.CreateCheckbox("Show Shadowlands Non-Covenant Specific Rares", "showSLRares", dailyPanel)
    local showCovenantRares = MC.CreateCheckbox("Show Shadowlands Covenant Specific Rares", "showCovenantRares", dailyPanel)
    local showCallings = MC.CreateCheckbox("Show Current Maldraxxus Calling Quests", "showCallings", dailyPanel)
    local showTWWRares = MC.CreateCheckbox("Show The War Within Rares", "showTWWRares", dailyPanel)
    ...
    local showWoDDailies = MC.CreateCheckbox("Show Warlords of Draenor Daily Activities", "showWoDDailies", dailyPanel)
    local showBfaDailies = MC.CreateCheckbox("Show Battle of Azeroth Daily Activities", "showBfaDailies", dailyPanel)
    local showSLDailies = MC.CreateCheckbox("Show Shadowlands Daily Activities", "showSLDailies", dailyPanel)
    local showDFDailies = MC.CreateCheckbox("Show Dragonflight Daily Activities", "showDFDailies", dailyPanel)
    local showTBCReps = MC.CreateCheckbox("Show Burning Crusade Reputations", "showTBCReps", repPanel)
    local showWOTLKReps = MC.CreateCheckbox("Show Wrath of Lich King Reputations", "showWOTLKReps", repPanel)
    local showCataReps = MC.CreateCheckbox("Show Cataclysm Reputations", "showCataReps", repPanel)
    local showPandariaReps = MC.CreateCheckbox("Show Pandaria Reputations", "showPandariaReps", repPanel)
    local showWoDReps = MC.CreateCheckbox("Show Warlords of Draenor Reputations", "showWoDReps", repPanel)
    local showLegionReps = MC.CreateCheckbox("Show Legion Reputations", "showLegionReps", repPanel)
    local showBfAReps = MC.CreateCheckbox("Show Battle for Azeroth Reputations", "showBfAReps", repPanel)
    local showSLReps = MC.CreateCheckbox("Show Shadowlands Reputations", "showSLReps", repPanel)
    local showSLCovenants = MC.CreateCheckbox("Show Shadowlands Covenants", "showSLCovenants", repPanel)
    local showDFRenownReps = MC.CreateCheckbox("Show Dragonflight Renowns", "showDFRenownReps", repPanel)
    local showDFOtherReps = MC.CreateCheckbox("Show Dragonflight Other Reputations", "showDFOtherReps", repPanel)
    local showTWWRenownReps = MC.CreateCheckbox("Show The War Within Renowns", "showTWWRenownReps", repPanel)
    local showTWWOtherReps = MC.CreateCheckbox("Show The War Within Other Reputations", "showTWWOtherReps", repPanel)
    ...
    local showSummonDepthsTimer = MC.CreateCheckbox("Show Nazjatar Summon from the Depths Timer", "showSummonDepthsTimer",
        eventPanel)
    local showMawAssaultTimer = MC.CreateCheckbox("Show Shadowlands The Maw Assault Timer", "showMawAssaultTimer", eventPanel)
    local showBeastwarrensHuntTimer = MC.CreateCheckbox("Show Shadowlands The Maw Beastwarrens Hunt Timer",
        "showBeastwarrensHuntTimer", eventPanel)
    local showTormentorsTimer = MC.CreateCheckbox("Show Shadowlands The Maw Tormentors of Torghast Timer", "showTormentorsTimer",
        eventPanel)
    ...
    local showBeledarShiftTimer = MC.CreateCheckbox("Show The War Within Beledar Dark Shift Timer", "showBeledarShiftTimer",
        eventPanel)
    ...
    showTWWDungeons:SetPoint("TOPLEFT", showGarrisonInvasions, "BOTTOMLEFT")
    showDFDungeons:SetPoint("TOPLEFT", showTWWDungeons, "BOTTOMLEFT")
    ...
    showTWWRaids:SetPoint("TOPLEFT", showBFADungeons, "BOTTOMLEFT")
    showDFRaids:SetPoint("TOPLEFT", showTWWRaids, "BOTTOMLEFT")
    ...
    showTBCDungeons:SetPoint("TOPLEFT", hideDailyTab, "BOTTOMLEFT")
    ...
    showTWWRares:SetPoint("TOPLEFT", showCallings, "BOTTOMLEFT")
    ...
    showTWWRenownReps:SetPoint("TOPLEFT", showDFOtherReps, "BOTTOMLEFT")
    showTWWOtherReps:SetPoint("TOPLEFT", showTWWRenownReps, "BOTTOMLEFT")
