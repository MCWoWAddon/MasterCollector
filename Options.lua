...
mainTitle:SetText("Master Collector V1.6")
...
function MC.CreateOptions()
    ...
    local showDFRares = MC.CreateCheckbox("Show Dragonflight Rares", "showDFRares", dailyPanel)
    ...
    local showLegendaryAlbumTimer = MC.CreateCheckbox("Show DF Legendary Album World Quest Timer/s",
    ...
    showDFRares:SetPoint("TOPLEFT", showCallings, "BOTTOMLEFT")
    ...
    showDreamsurgesTimer:SetPoint("TOPLEFT", showHuntsTimer, "BOTTOMLEFT")
    ...
    showLegendaryAlbumTimer:SetPoint("TOPLEFT", showFroststoneStormTimer, "BOTTOMLEFT")
    showResearchersUnderFireTimer:SetPoint("TOPLEFT", showLegendaryAlbumTimer, "BOTTOMLEFT")

    showSuperbloomTimer:SetPoint("TOPLEFT", eventTitle, "BOTTOMLEFT", 400, -10)
